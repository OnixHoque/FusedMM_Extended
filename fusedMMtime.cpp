...
)
{
   ...
   printf("Directly Calling fusedmm_csr...");
   
   // c[0] = 10000; c[1] = 10000; c[2] = 10000; c[3] = 10000; // For AOP_MIN
   fusedMM_csr(imessage, m, n, k, alpha, nnz, rows, cols, val, indx, pntrb, 
      pntre, a, lda, b, ldb, beta, c, ldc, c_arg);
...
void performDummySpMM(int flag)
{
 ...
 */
   ...
   c_arg = (INDEXTYPE*)calloc(4,sizeof(INDEXTYPE));
 ...
 */
   ...
   INDEXTYPE S_rows = 2;	
	INDEXTYPE S_cols = 3;
	INDEXTYPE S_nnz = 5; // number of nonzeros
    
   INDEXTYPE S_rowptr[] = {0, 3, 5};
   INDEXTYPE S_colids[] = {0, 1, 2, 0, 1};
   VALUETYPE S_values[] = {1, 2, 3, 4, 5};
   ...
   if (flag == 1){
      ...
      // c[0] = 10000; c[1] = 10000; c[2] = 10000; c[3] = 10000; 
   }
   else if (flag == 2){
      printf("\nPerforming SpMM-Min\n");
   ...
   SpMM(imsg, M, N, K, alpha, S_nnz, S_rows, S_cols, S_values, S_colids, S_rowptr, S_rowptr+1, a, lda, b, ldb, beta, c, ldc, c_arg);   
