...
#define MAXDIM_GCN 32 /* max value of dimension (k) */
#define KRUNTIME_GCN 0
/*
 ...
 */
   kern_sgfusedMM_gcn_b0_t sgenkernels_gcn_b0[4] = 
   {
 ...
 * keep a global array of function pointer to select the correct one 
 */
   kern_sgfusedMM_gcn_b1_t sgenkernels_gcn_b1[4] = 
   {
