...
#ifdef BETA0
void sgfusedMM_K392_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K392_tdist_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc46, Va47, Vc47, Va48, Vc48;
      INDEXTYPE iindex = i * 392; 
