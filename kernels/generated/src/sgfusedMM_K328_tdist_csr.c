...
#ifdef BETA0
void sgfusedMM_K328_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K328_tdist_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc36, Va37, Vc37, Va38, Vc38, Va39, Vc39, Va40, Vc40;
      INDEXTYPE iindex = i * 328; 
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4, Vb5, Vb6, Vb7, Vb8, Vb9, Vb10, Vb11,
               ...
               Vb34, Vb35, Vb36, Vb37, Vb38, Vb39, Vb40;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vd6, Vd7, Vd8, Vd9, Vd10, Vd11,
               ...
               Vd34, Vd35, Vd36, Vd37, Vd38, Vd39, Vd40, Vt;
