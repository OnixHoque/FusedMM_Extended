 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4, Vb5, Vb6, Vb7, Vb8, Vb9, Vb10, Vb11,
               ...
               Vb56, Vb57, Vb58, Vb59, Vb60, Vb61, Vb62, Vb63;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vd6, Vd7, Vd8, Vd9, Vd10, Vd11,
               ...
               Vd56, Vd57, Vd58, Vd59, Vd60, Vd61, Vd62, Vd63, Vt;
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7, Vatt8,
               ...
               Vatt57, Vatt58, Vatt59, Vatt60, Vatt61, Vatt62, Vatt63;
         float attrc = 0;
      ...
      // vsub
         ...
         BCL_vsub(Vd59, Va59, Vb59);
         BCL_vsub(Vd60, Va60, Vb60);
         BCL_vsub(Vd61, Va61, Vb61);
         BCL_vsub(Vd62, Va62, Vb62);
         BCL_vsub(Vd63, Va63, Vb63);
      // vmac 
         ...
         BCL_vmac(Vatt59, Vd59, Vd59);
         BCL_vmac(Vatt60, Vd60, Vd60);
         BCL_vmac(Vatt61, Vd61, Vd61);
         BCL_vmac(Vatt62, Vd62, Vd62);
         BCL_vmac(Vatt63, Vd63, Vd63);
      ...
      // vmul 
         ...
         BCL_vmul(Vd59, Vatt0, Vd59);
         BCL_vmul(Vd60, Vatt0, Vd60);
         BCL_vmul(Vd61, Vatt0, Vd61);
         BCL_vmul(Vd62, Vatt0, Vd62);
         BCL_vmul(Vd63, Vatt0, Vd63);
      // vadd 
         ...
         BCL_vadd(Vc59, Vc59, Vd59);
         BCL_vadd(Vc60, Vc60, Vd60);
         BCL_vadd(Vc61, Vc61, Vd61);
         BCL_vadd(Vc62, Vc62, Vd62);
         BCL_vadd(Vc63, Vc63, Vd63);
#if 0
         attrc = Vatt0[0]; 
