...
#ifdef BETA0
void sgfusedMM_K504_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K504_tdist_b1_csr
#endif
(
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4, Vb5, Vb6, Vb7, Vb8, Vb9, Vb10, Vb11,
               ...
               Vb56, Vb57, Vb58, Vb59, Vb60, Vb61, Vb62;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vd6, Vd7, Vd8, Vd9, Vd10, Vd11,
               ...
               Vd56, Vd57, Vd58, Vd59, Vd60, Vd61, Vd62, Vt;
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7, Vatt8,
               ...
               Vatt57, Vatt58, Vatt59, Vatt60, Vatt61, Vatt62;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*504;
