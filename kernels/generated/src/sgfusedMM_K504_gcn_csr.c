 ...
 */
#ifdef BETA0 
void sgfusedMM_K504_gcn_b0_csr
#else /* BETA1 version */
void sgfusedMM_K504_gcn_b1_csr
#endif
(
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         ...
         BCL_vadd(Vc51, Vc51, Vb51);
         BCL_vadd(Vc52, Vc52, Vb52);
         BCL_vadd(Vc53, Vc53, Vb53);
         BCL_vadd(Vc54, Vc54, Vb54);
         BCL_vadd(Vc55, Vc55, Vb55);
         BCL_vadd(Vc56, Vc56, Vb56);
         BCL_vadd(Vc57, Vc57, Vb57);
         BCL_vadd(Vc58, Vc58, Vb58);
         BCL_vadd(Vc59, Vc59, Vb59);
         BCL_vadd(Vc60, Vc60, Vb60);
         BCL_vadd(Vc61, Vc61, Vb61);
         BCL_vadd(Vc62, Vc62, Vb62);
      }
