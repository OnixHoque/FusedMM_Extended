...
#ifdef BETA0
void sgfusedMM_K440_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K440_tdist_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc51, Va52, Vc52, Va53, Vc53, Va54, Vc54;
      INDEXTYPE iindex = i * 440; 
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4, Vb5, Vb6, Vb7, Vb8, Vb9, Vb10, Vb11,
               ...
               Vb45, Vb46, Vb47, Vb48, Vb49, Vb50, Vb51, Vb52, Vb53, Vb54;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vd6, Vd7, Vd8, Vd9, Vd10, Vd11,
               ...
               Vd45, Vd46, Vd47, Vd48, Vd49, Vd50, Vd51, Vd52, Vd53, Vd54, Vt;
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7, Vatt8,
               ...
               Vatt49, Vatt50, Vatt51, Vatt52, Vatt53, Vatt54;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*440;
