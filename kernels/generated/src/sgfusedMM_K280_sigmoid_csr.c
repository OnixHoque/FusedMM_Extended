...
#ifdef BETA0 
void sgfusedMM_K280_sigmoid_b0_csr
#else /* BETA1 version */
void sgfusedMM_K280_sigmoid_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc31, Va32, Vc32, Va33, Vc33, Va34, Vc34;
      INDEXTYPE iindex = i * 280; 
