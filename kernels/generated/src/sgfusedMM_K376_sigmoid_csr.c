...
#ifdef BETA0 
void sgfusedMM_K376_sigmoid_b0_csr
#else /* BETA1 version */
void sgfusedMM_K376_sigmoid_b1_csr
#endif
(
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         ...
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7, Vatt8,
               ...
               Vatt41, Vatt42, Vatt43, Vatt44, Vatt45, Vatt46;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*376;
