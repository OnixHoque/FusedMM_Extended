...
def spmm_sum(src: SparseTensor, other: torch.Tensor) -> torch.Tensor:
    ...
    # print("TRAINING_STATUS", builtins.TRAINING_STATUS)
    # print('requires grad', other.requires_grad, value.requires_grad)
    # print("Result from pytorch_sparse:")
    # print(ret_)
    # print("Result from fusedmm:")
    # print(ret)
    # print("Returning FusedMM result...")
    # return torch.ops.torch_sparse.spmm_sum(row, rowptr, col, value, colptr, csr2csc, other)
    if builtins.TRAINING_STATUS == True:
      ret_ = torch.ops.torch_sparse.spmm_sum(row, rowptr, col, value, colptr, csr2csc, other)
      return ret_
    else:
      print('Using FusedMM SpMM...')
      ret = fusedmm.spmm_fusedmm_v1(rowptr, col, value, other) 
      return ret
